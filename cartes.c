...
void attributionCarteChance(int numero, Joueurs* j) {
    ...
    switch (numero) {
        case 0 :
            ...
            break;
        case 1 :
            printf("Zidane vous fait . Collectez votre salaire si vous passez la case d%cpart\n", 130);
        ...
        case 7 :
            ...
            if(j->argent <=0 && j->placement == 15) {
                fonctionHypoteque(tabCase[14],j, 25 * nbM + 100 * nbH + 25 * nbM + 100 * nbH);
            }
            else if(j->argent <=0 && j->placement == 31) {
                fonctionHypoteque(tabCase[30],j, 25 * nbM + 100 * nbH + 25 * nbM + 100 * nbH);
            }
                // Sinon : cas de faillite (cf fonction de Pierre)
            else if (j->argent <= 0 && j->fortune <= 0) {
            }
            break;
        case 8 :
            ...
            j->fortune -= 50 * a;
            if(j->argent <=0 && j->placement == 15) {
                fonctionHypoteque(tabCase[14],j, 50 * a);
            }
            else if(j->argent <=0 && j->placement == 31) {
                fonctionHypoteque(tabCase[30],j, 50 * a);
            }
                // Sinon : cas de faillite (cf fonction de Pierre)
            else if (j->argent <= 0 && j->fortune <= 0) {
            }
        ...
        case 9 :
            ...
            break;
            if(j->argent <=0 && j->placement == 15) {
                fonctionHypoteque(tabCase[14],j, 100);
            }
            else if(j->argent <=0 && j->placement == 31) {
                fonctionHypoteque(tabCase[30],j, 100);
            }
                // Sinon : cas de faillite (cf fonction de Pierre)
            else if (j->argent <= 0 && j->fortune <= 0) {
            }
...
void attributionCarteCommunaute(int numero, Joueurs* j) {
    ...
    switch (numero) {
        ...
        case 2 :
            ...
            j->fortune -= 50;
            if(j->argent <=0 && j->placement == 15) {
                fonctionHypoteque(tabCase[14],j, 50);
            }
            else if(j->argent <=0 && j->placement == 31) {
                fonctionHypoteque(tabCase[30],j, 50);
            }
            break;
        case 3 :
